/**
 * Intent classification logic using Vercel AI SDK with Groq.
 ...
 * Returns an Intent object indicating how to handle the message.
 */
export async function classifyIntent(
  message: string,
  isInitialPrompt: boolean = false,
  persona: ChatMessageFromPersona = 'auto'
): Promise<Intent> {
  const defaultIntent: Intent = {
